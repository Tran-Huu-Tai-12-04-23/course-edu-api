...
namespace course_edu_api.Migrations
{
    ...
    [Migration("20240325041102_Up description for post")]
    partial class Updescriptionforpost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("course_edu_api.Entities.Answer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long?>("QuizzLessonId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("QuizzLessonId");
            ...
            modelBuilder.Entity("course_edu_api.Entities.QuizzLesson", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("course_edu_api.Entities.Answer", b =>
                {
                    b.HasOne("course_edu_api.Entities.QuizzLesson", null)
                        .WithMany("Answers")
                        .HasForeignKey("QuizzLessonId");
                });
            ...
            modelBuilder.Entity("course_edu_api.Entities.Lesson", b =>
                {
                    ...
                    b.HasOne("course_edu_api.Entities.QuizzLesson", "Quizz")
                        .WithMany()
            ...
            modelBuilder.Entity("course_edu_api.Entities.PostLesson", b =>
                {
                    b.HasOne("course_edu_api.Entities.Post", "Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
