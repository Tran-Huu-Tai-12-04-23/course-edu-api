...
namespace course_edu_api.Data
{
    public class DataContext: DbContext
    {
        ...
        private void InitDataTypeCourse()
        {
            if (TypeCourses.Any()) return;
            var typeCourses = new TypeCourse[]
            {
                new TypeCourse( "Khóa học về SEO website"),
                new TypeCourse( "Khóa học về Python"),
                new TypeCourse( "Khóa học về NextJs"),
                new TypeCourse( "Khóa học về SEO website"),
                new TypeCourse( "Khóa học về Python"),
                new TypeCourse( "Khóa học về Marketing")
            };
            TypeCourses.AddRange(typeCourses);
            SaveChanges();
        }
        ...
        private void InitData()
        {
            ...
            if (Courses.Any() || !TypeCourses.Any()) return;

            var typeCourses =  TypeCourses.ToListAsync();
            
            var courses = new Course[]
            {
                new Course("Course 1", "Description 1", 109.99, "https://files.fullstack.edu.vn/f8-prod/courses/21/63e1bcbaed1dd.png", "video1.mp4", typeCourses.Result[0]),
                new Course("Course 6", "Description 6", 690.99, "https://files.fullstack.edu.vn/f8-prod/courses/3.png", "video6.mp4", typeCourses.Result[1]),
                new Course("Course 8", "Description 8", 890.99, "https://files.fullstack.edu.vn/f8-prod/courses/7.png", "video8.mp4", typeCourses.Result[2]),
                new Course(
        ...
        public DbSet<TypeCourse> TypeCourses { get; set; }
